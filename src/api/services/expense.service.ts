...
export class ExpenseService extends BaseService {
  ...
  apiExpenseGet$Plain(params?: {
    ...
    return this.apiExpenseGet$Plain$Response(params).pipe(
  ...
  apiExpenseGet$Json(params?: {
    ...
    return this.apiExpenseGet$Json$Response(params).pipe(
      map((r: StrictHttpResponse<Array<ExpenseDto>>) => r.body as Array<ExpenseDto>)
    );
  }
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiExpensePost()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiExpensePost$Response(params?: {
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiExpensePost$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiExpensePost(params?: {
    body?: CreateExpenseDto
  }): Observable<void> {

    return this.apiExpensePost$Response(params).pipe(
  ...
  apiExpenseIdGet$Plain(params: {
    ...
    return this.apiExpenseIdGet$Plain$Response(params).pipe(
  ...
  apiExpenseIdGet$Json(params: {
    ...
    return this.apiExpenseIdGet$Json$Response(params).pipe(
      map((r: StrictHttpResponse<ExpenseDto>) => r.body as ExpenseDto)
    );
  }
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apiExpenseIdPut()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiExpenseIdPut$Response(params: {
    id: string;
  ...
  /**
   * This method provides access to only to the response body.
   * To access the full response (for headers, for example), `apiExpenseIdPut$Response()` instead.
   *
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  apiExpenseIdPut(params: {
    id: string;
    body?: UpdateExpenseDto
  }): Observable<void> {

    return this.apiExpenseIdPut$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
  ...
  apiExpenseIdDelete(params: {
    ...
    return this.apiExpenseIdDelete$Response(params).pipe(
      map((r: StrictHttpResponse<void>) => r.body as void)
    );
  }
